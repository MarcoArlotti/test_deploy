...
-- Inserimento canali (usando gli id delle categorie)
INSERT INTO canali (nome, numero_iscritti, categoria_id)
VALUES ('Tech Guru', 1500, 1);

INSERT INTO canali (nome, numero_iscritti, categoria_id)
VALUES ('Chef Stellato', 85000, 2);

INSERT INTO canali (nome, numero_iscritti, categoria_id)
VALUES ('Gaming Zone', 1200, 3);

-- Inserimento video
INSERT INTO video (canale_id, titolo, durata, immagine)
VALUES (1, 'Recensione iPhone 15', 600, 'iphone.jpg');

INSERT INTO video (canale_id, titolo, durata, immagine)
VALUES (1, 'Come programmare in Python', 1200, 'python.jpg');

INSERT INTO video (canale_id, titolo, durata, immagine)
VALUES (2, 'Pasta alla Carbonara perfetta', 450, 'carbonara.jpg');

INSERT INTO video (canale_id, titolo, durata, immagine)
VALUES (3, 'Gameplay Minecraft Parte 1', 1800, 'minecraft.jpg');